  ...
  <body>
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="post-heading">
              <h1>NEW CONCEPT</h1>
              <img class="" src="img/new.png" alt="">
              <h2 class="subheading">Dibawah Ini Adalah Biaya Pendaftaran New Concept</h2>
              <span class="meta">
                <a href="#"></span>
            </div>
          </div>
    ...
    <article>
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <img class="img-fluid" src="img/t.jpg" alt="">
            <<a class="nav-link" href="tambah.php">Anda Berminat? Klik Tulisan Ini!</h2> 
          </div>
        </div>
      </div>
    </article>
